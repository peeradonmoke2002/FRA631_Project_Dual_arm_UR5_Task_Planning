...
def main():
    ...
    while True:
        ...
        candidates = [
            ...
            if m["id"] in {100, 101, 102} and m["id"] not in mover.used_empty_markers
        ]

        if not candidates:
            print("[DESTACK] No empty destack spots (100–102) left. Switching to final stacking at 104")
            break  # will proceed to stacking at marker 104
